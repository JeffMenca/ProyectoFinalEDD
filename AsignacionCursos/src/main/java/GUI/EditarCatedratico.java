...
public class EditarCatedratico extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EditarCatedratico
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar catedratico");
        ...
        IngresarjButton.setText("Editar catedratico");
    ...
    private void IngresarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IngresarjButtonActionPerformed
        if (IDJTextField.getText() != null && !"".equals(IDJTextField.getText())) {
            try {
                ...
                JOptionPane.showMessageDialog(null, "El id del catedratico no es valido");
            }
        }
