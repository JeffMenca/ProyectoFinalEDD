...
public class EditarCurso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        IngresarjButton.setText("Editar curso");
                    ...
                    if (NombreJTextField1.getText() != null && !"".equals(NombreJTextField1.getText())) {
                        if (CreditosJTextField.getText() != null && !"".equals(CreditosJTextField.getText())) {
                            if (SemestreJTextField.getText() != null && !"".equals(SemestreJTextField.getText())) {
                                curso.setNombre(NombreJTextField1.getText());
                                curso.setCreditos(Integer.valueOf(CreditosJTextField.getText()));
                                curso.setSemestre(Integer.valueOf(SemestreJTextField.getText()));
                                JOptionPane.showMessageDialog(null, "Se edito el curso correctamente");
                            } else {
                                JOptionPane.showMessageDialog(null, "No ingreso el nuevo numero de semestre");
                            }
                        } else {
                            JOptionPane.showMessageDialog(null, "No ingreso el nuevo numero de creditos");
                        }
                    } else {
