...
public class EditarSalon extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        IngresarjButton1.setText("Editar salon");
                    ...
                    if (NumeroJTextField1.getText() != null && !"".equals(NumeroJTextField1.getText())) {
                        if (CapacidadJTextField1.getText() != null && !"".equals(CapacidadJTextField1.getText())) {
                            ...
                            if (salonEncontrado != null) {
                                CapacidadJTextField1.setText(String.valueOf(salonEncontrado.getCapacidad()));
            ...
            if (edificio != null) {
                if (NumeroJTextField1.getText() != null && !"".equals(NumeroJTextField1.getText())) {
                    if (CapacidadJTextField1.getText() != null && !"".equals(CapacidadJTextField1.getText())) {
                        Salon salonEncontrado = (Salon) edificio.salones.getData(NumeroJTextField1.getText());
                        if (salonEncontrado != null) {
                            salonEncontrado.setCapacidad(Integer.valueOf(CapacidadJTextField1.getText()));
                            JOptionPane.showMessageDialog(null, "Se edito el salon correctamente");
